...
var FirebaseAppImpl2 = class {
   ...
   * @internal
   */
  _getService(name3, instanceIdentifier = DEFAULT_ENTRY_NAME2) {
    var _a;
    this._delegate.checkDestroyed();
   ...
   * @internal
   */
  _removeServiceInstance(name3, instanceIdentifier = DEFAULT_ENTRY_NAME2) {
...
function createFirebaseNamespaceCore(firebaseAppImpl) {
  ...
  function app(name3) {
    name3 = name3 || DEFAULT_ENTRY_NAME2;
...
@firebase/app-compat/dist/esm/index.esm2017.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-PPNBXIED.js.map
