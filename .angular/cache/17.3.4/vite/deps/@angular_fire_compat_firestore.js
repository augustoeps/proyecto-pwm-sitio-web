...
var __PRIVATE_IndexBackfillerScheduler = class {
  ...
  ee(e) {
    __PRIVATE_logDebug("IndexBackfiller", `Scheduled in ${e}ms`), this.task = this.asyncQueue.enqueueAfterDelay("index_backfill", e, () => __async(this, null, function* () {
      this.task = null;
      try {
        __PRIVATE_logDebug("IndexBackfiller", `Documents written: ${yield this.X.te()}`);
      } catch (e2) {
...
var __PRIVATE_IndexBackfiller = class {
  ...
  ne(e, t) {
    ...
    return PersistencePromise.doWhile(() => true === i && r2 > 0, () => this.localStore.indexManager.getNextCollectionGroupToUpdate(e).next((t2) => {
      if (null !== t2 && !n.has(t2))
        return __PRIVATE_logDebug("IndexBackfiller", `Processing collection: ${t2}`), this.re(e, t2, r2).next((e2) => {
          r2 -= e2, n.add(t2);
        });
      i = false;
    })).next(() => t - r2);
  ...
  re(e, t, n) {
    return this.localStore.indexManager.getMinOffsetFromCollectionGroup(e, t).next((r2) => this.localStore.localDocuments.getNextDocuments(e, t, r2, n).next((n2) => {
      const i = n2.changes;
      return this.localStore.indexManager.updateIndexEntries(e, i).next(() => this.ie(r2, n2)).next((n3) => (__PRIVATE_logDebug("IndexBackfiller", `Updating offset: ${n3}`), this.localStore.indexManager.updateCollectionGroup(e, t, n3))).next(() => i.size);
    }));
  }
...
var __PRIVATE_WatchChangeAggregator = class {
  constructor(e) {
    this.Be = e, /** The internal state of all tracked targets. */
  ...
  rt(e, t) {
    ...
    let r2 = 0;
    return n.forEach((n2) => {
      const i = this.Be.nt(), s = `projects/${i.projectId}/databases/${i.database}/documents/${n2.path.canonicalString()}`;
...
function __PRIVATE_fromDbMutationBatch(e, t) {
  ...
  const r2 = t.mutations.map((t2) => __PRIVATE_fromMutation(e.ct, t2)), i = Timestamp.fromMillis(t.localWriteTimeMs);
...
function __PRIVATE_toDbTarget(e, t) {
  ...
  let i;
  i = __PRIVATE_targetIsDocumentTarget(t.target) ? __PRIVATE_toDocumentsTarget(e.ct, t.target) : __PRIVATE_toQueryTarget(e.ct, t.target).ut;
  ...
  Nt(e) {
    for (const t of e) {
      ...
      if (e2 < 128)
        ...
        this.Mt(960 | e2 >>> 6), this.Mt(128 | 63 & e2);
      else if (t < "\uD800" || "\uDBFF" < t)
        this.Mt(480 | e2 >>> 12), this.Mt(128 | 63 & e2 >>> 6), this.Mt(128 | 63 & e2);
      else {
        const e3 = t.codePointAt(0);
        this.Mt(240 | e3 >>> 18), this.Mt(128 | 63 & e3 >>> 12), this.Mt(128 | 63 & e3 >>> 6), this.Mt(128 | 63 & e3);
      }
    }
    this.xt();
  }
...
var __PRIVATE_TargetIndexMatcher = class {
  constructor(e) {
    this.Yt = new SortedSet((e2, t) => FieldPath$1.comparator(e2.field, t.field)), this.collectionId = null != e.collectionGroup ? e.collectionGroup : e.path.lastSegment(), this.Zt = e.orderBy, this.Xt = [];
    for (const t of e.filters) {
      const e2 = t;
      e2.isInequality() ? this.Yt = this.Yt.add(e2) : this.Xt.push(e2);
    }
  }
  get en() {
  ...
  tn(e) {
    ...
    if (i === n.length)
      return true;
    if (this.Yt.size > 0) {
      const e2 = this.Yt.getIterator().getNext();
      if (!r2.has(e2.field.canonicalString())) {
        const t2 = n[i];
        if (!this.rn(e2, t2) || !this.sn(this.Zt[s++], t2))
          return false;
      }
      ++i;
    }
...
var __PRIVATE_IndexedDbIndexManager = class {
  constructor(e, t) {
     ...
     */
    this.un = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), (e2, t2) => __PRIVATE_targetEquals(e2, t2)), this.uid = e.uid || "";
  }
  /**
  ...
  createTargetIndexes(e, t) {
    return PersistencePromise.forEach(this.cn(t), (t2) => this.getIndexType(e, t2).next((n) => {
      if (0 === n || 1 === n) {
        const n2 = new __PRIVATE_TargetIndexMatcher(t2).on();
        if (null != n2)
  ...
  getDocumentsMatchingTarget(e, t) {
    ...
    return PersistencePromise.forEach(this.cn(t), (t2) => this.ln(e, t2).next((e2) => {
      ...
      if (r2) {
        ...
        return PersistencePromise.forEach(i, (i2, s) => {
          ...
          const o = function __PRIVATE_targetGetArrayValues(e3, t2) {
            ...
            return new Bound(n2, r4);
          }(s, i2), c = this.hn(i2, s, a), l2 = this.hn(i2, s, u), h = this.Pn(i2, s, _), P2 = this.In(i2.indexId, o, c, a.inclusive, l2, u.inclusive, h);
  ...
  In(e, t, n, r2, i, s, o) {
    ...
    for (let c = 0; c < _; ++c) {
      const _2 = t ? this.Tn(t[c / a]) : Ee, l2 = this.En(e, _2, n[c % a], r2), h = this.dn(e, _2, i[c % a], s), P2 = o.map((t2) => this.En(
        e,
        _2,
        t2,
        /* inclusive= */
  ...
  getIndexType(e, t) {
    let n = 2;
    const r2 = this.cn(t);
    return PersistencePromise.forEach(r2, (t2) => this.ln(e, t2).next((e2) => {
  ...
  An(e, t) {
    ...
    for (const r2 of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      ...
      if (null == e2)
        return null;
      const i = n.Ht(r2.kind);
      __PRIVATE_FirestoreIndexValueWriter.bt.Pt(e2, i);
    }
    return n.Wt();
  }
  ...
  Tn(e) {
    ...
    return __PRIVATE_FirestoreIndexValueWriter.bt.Pt(e, t.Ht(
      0
      /* IndexKind.ASCENDING */
    )), t.Wt();
  }
  ...
  Rn(e, t) {
    const n = new __PRIVATE_IndexByteEncoder();
    return __PRIVATE_FirestoreIndexValueWriter.bt.Pt(__PRIVATE_refValue(this.databaseId, t), n.Ht(function __PRIVATE_fieldIndexGetKeyOrder(e2) {
  ...
  Pn(e, t, n) {
    ...
    for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      const e2 = n[i++];
      for (const n2 of r2)
        if (this.Vn(t, s.fieldPath) && isArray(e2))
          r2 = this.mn(r2, s, e2);
        else {
          const t2 = n2.Ht(s.kind);
          __PRIVATE_FirestoreIndexValueWriter.bt.Pt(e2, t2);
        }
    }
    return this.fn(r2);
  }
  ...
  mn(e, t, n) {
    ...
    for (const e2 of n.arrayValue.values || [])
      for (const n2 of r2) {
        ...
        r3.seed(n2.Wt()), __PRIVATE_FirestoreIndexValueWriter.bt.Pt(e2, r3.Ht(t.kind)), i.push(r3);
      }
    return i;
  }
  Vn(e, t) {
  ...
  updateCollectionGroup(e, t, n) {
    ...
    return this.gn(e).next((e2) => r2.W("collectionGroupIndex", IDBKeyRange.bound(t, t)).next((t2) => PersistencePromise.forEach(t2, (t3) => i.put(__PRIVATE_toDbIndexState(t3.indexId, this.uid, e2, n)))));
  }
  updateIndexEntries(e, t) {
    const n = /* @__PURE__ */ new Map();
    return PersistencePromise.forEach(t, (t2, r2) => {
      const i = n.get(t2.collectionGroup);
      return (i ? PersistencePromise.resolve(i) : this.getFieldIndexes(e, t2.collectionGroup)).next((i2) => (n.set(t2.collectionGroup, i2), PersistencePromise.forEach(i2, (n2) => this.pn(e, t2, n2).next((t3) => {
        const i3 = this.yn(r2, n2);
        return t3.isEqual(i3) ? PersistencePromise.resolve() : this.wn(e, r2, n2, t3, i3);
      }))));
    });
  }
  Sn(e, t, n, r2) {
  ...
  bn(e, t, n, r2) {
    return __PRIVATE_indexEntriesStore(e).delete([r2.indexId, this.uid, r2.arrayValue, r2.directionalValue, this.Rn(n, t.key), t.key.path.toArray()]);
  }
  pn(e, t, n) {
    ...
    if (null != i) {
      ...
      if (isArray(s))
        for (const i2 of s.arrayValue.values || [])
          n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.Tn(i2), r2));
    } else
  ...
  getMinOffset(e, t) {
    return PersistencePromise.mapArray(this.cn(t), (t2) => this.ln(e, t2).next((e2) => e2 || fail())).next(__PRIVATE_getMinOffsetFromFieldIndexes);
  }
};
...
var __PRIVATE_IndexedDbMutationQueue = class ___PRIVATE_IndexedDbMutationQueue {
  ...
  addMutationBatch(e, t, n, r2) {
    ...
    return s.add({}).next((o) => {
      ...
      const _ = new MutationBatch(o, t, n, r2), a = function __PRIVATE_toDbMutationBatch(e2, t2, n2) {
        const r3 = n2.baseMutations.map((t3) => toMutation(e2.ct, t3)), i2 = n2.mutations.map((t3) => toMutation(e2.ct, t3));
        return {
          userId: t2,
          batchId: n2.batchId,
  ...
  // PORTING NOTE: Multi-tab only.
  vn(e, t) {
    return this.Cn[t] ? PersistencePromise.resolve(this.Cn[t]) : this.lookupMutationBatch(e, t).next((e2) => {
      if (e2) {
        const n = e2.keys();
  ...
  getAllMutationBatchesAffectingDocumentKeys(e, t) {
    ...
    return t.forEach((t2) => {
      ...
      r2.push(o);
    }), PersistencePromise.waitFor(r2).next(() => this.Fn(e, n));
  }
...
var __PRIVATE_IndexedDbTargetCache = class {
  ...
  setTargetsMetadata(e, t, n) {
    return this.Bn(e).next((r2) => (r2.highestListenSequenceNumber = t, n && (r2.lastRemoteSnapshotVersion = n.toTimestamp()), t > r2.highestListenSequenceNumber && (r2.highestListenSequenceNumber = t), this.kn(e, r2)));
  }
  addTargetData(e, t) {
  ...
  removeTargetData(e, t) {
    return this.removeMatchingKeysForTargetId(e, t.targetId).next(() => __PRIVATE_targetsStore(e).delete(t.targetId)).next(() => this.Bn(e)).next((t2) => (__PRIVATE_hardAssert(t2.targetCount > 0), t2.targetCount -= 1, this.kn(e, t2)));
  }
  /**
...
var __PRIVATE_LruScheduler = class {
  ...
  zn(e) {
    __PRIVATE_logDebug("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.Gn = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection", e, () => __async(this, null, function* () {
      this.Gn = null;
      try {
...
var __PRIVATE_LruGarbageCollectorImpl = class {
  ...
  calculateTargetCount(e, t) {
    return this.jn.Hn(e).next((e2) => Math.floor(t / 100 * e2));
  }
  nthSequenceNumber(e, t) {
    if (0 === t)
      return PersistencePromise.resolve(__PRIVATE_ListenSequence._e);
    const n = new __PRIVATE_RollingSequenceNumberBuffer(t);
    return this.jn.forEachTarget(e, (e2) => n.Wn(e2.sequenceNumber)).next(() => this.jn.Jn(e, (e2) => n.Wn(e2))).next(() => n.maxValue);
  }
  removeTargets(e, t, n) {
...
var __PRIVATE_IndexedDbRemoteDocumentCacheImpl = class {
  ...
  getEntries(e, t) {
    ...
    return this.ir(e, t, (e2, t2) => {
      const r2 = this.nr(e2, t2);
      n = n.insert(e2, r2);
    }).next(() => n);
  }
  /**
  ...
  getDocumentsMatchingQuery(e, t, n, r2, i) {
    ...
    return __PRIVATE_remoteDocumentsStore(e).W(IDBKeyRange.bound(o, _, true)).next((e2) => {
      ...
      for (const i2 of e2) {
        const e3 = this.nr(DocumentKey.fromSegments(i2.prefixPath.concat(i2.collectionGroup, i2.documentId)), i2);
  ...
  getAllFromCollectionGroup(e, t, n, r2) {
    ...
    return __PRIVATE_remoteDocumentsStore(e).Y({
      ...
      const s2 = this.nr(DocumentKey.fromSegments(t2.prefixPath.concat(t2.collectionGroup, t2.documentId)), t2);
...
var __PRIVATE_IndexedDbRemoteDocumentChangeBuffer = class extends RemoteDocumentChangeBuffer {
   ...
   */
  constructor(e, t) {
    super(), this.ar = e, this.trackRemovals = t, // A map of document sizes and read times prior to applying the changes in
    // this buffer.
    this.ur = new ObjectMap((e2) => e2.toString(), (e2, t2) => e2.isEqual(t2));
  }
  applyChanges(e) {
    const t = [];
    ...
    return this.changes.forEach((i, s) => {
      ...
      if (t.push(this.ar.removeEntry(e, i, o.readTime)), s.isValidDocument()) {
        ...
        const n2 = __PRIVATE_toDbRemoteDocument(this.ar.serializer, s.convertToNoDocument(SnapshotVersion.min()));
        t.push(this.ar.addEntry(e, i, n2));
      }
    }), r2.forEach((n2) => {
      t.push(this.ar.indexManager.addToCollectionParentIndex(e, n2));
    }), t.push(this.ar.updateMetadata(e, n)), PersistencePromise.waitFor(t);
  }
  getFromCache(e, t) {
    return this.ar.rr(e, t).next((e2) => (this.ur.set(t, {
      size: e2.size,
      readTime: e2.document.readTime
    }), e2.document));
  }
  getAllFromCache(e, t) {
    return this.ar.sr(e, t).next(({ documents: e2, _r: t2 }) => (
...
var __PRIVATE_SchemaConverter = class {
  ...
  N(e, t, n, r2) {
    ...
    (s = s.next(() => function __PRIVATE_upgradeMutationBatchSchemaAndMigrateData(e2, t2) {
    ...
    })), n < 5 && r2 >= 5 && (s = s.next(() => this.Xr(i))), n < 6 && r2 >= 6 && (s = s.next(() => (function __PRIVATE_createDocumentGlobalStore(e2) {
      e2.createObjectStore("remoteDocumentGlobal");
    }(e), this.ei(i)))), n < 7 && r2 >= 7 && (s = s.next(() => this.ti(i))), n < 8 && r2 >= 8 && (s = s.next(() => this.ni(e, i))), n < 9 && r2 >= 9 && (s = s.next(() => {
    ...
    })), n < 10 && r2 >= 10 && (s = s.next(() => this.ri(i))), n < 11 && r2 >= 11 && (s = s.next(() => {
      ...
      t2.createIndex("documentKeyIndex", N2), t2.createIndex("collectionGroupIndex", L);
    }(e)).next(() => this.ii(e, i)).next(() => e.deleteObjectStore("remoteDocuments"))), n < 14 && r2 >= 14 && (s = s.next(() => this.si(e, i))), n < 15 && r2 >= 15 && (s = s.next(() => function __PRIVATE_createFieldIndex(e2) {
  ...
  si(e, t) {
    const n = t.store("mutations"), r2 = __PRIVATE_newIndexedDbRemoteDocumentCache(this.serializer), i = new __PRIVATE_MemoryPersistence(__PRIVATE_MemoryEagerDelegate.Hr, this.serializer.ct);
    return n.W().next((e2) => {
      const n2 = /* @__PURE__ */ new Map();
...
function __PRIVATE_createQueryCache(e) {
  ...
  e.createObjectStore("targets", {
    keyPath: "targetId"
  }).createIndex("queryTargetsIndex", B2, {
    unique: true
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r2, i, s, o, _, a, u, c = 16) {
    if (this.allowTabSynchronization = e, this.persistenceKey = t, this.clientId = n, this.oi = i, this.window = s, this.document = o, this._i = a, this.ai = u, this.ui = c, this.kr = null, this.qr = false, this.isPrimary = false, this.networkEnabled = true, /** Our window.unload handler, if registered. */
    ...
    this.Ii = (e2) => Promise.resolve(), !___PRIVATE_IndexedDbPersistence.D())
    ...
    this.referenceDelegate = new __PRIVATE_IndexedDbLruDelegateImpl(this, r2), this.Ti = t + "main", this.serializer = new __PRIVATE_LocalSerializer(_), this.Ei = new __PRIVATE_SimpleDb(this.Ti, this.ui, new __PRIVATE_SchemaConverter(this.serializer)), this.Qr = new __PRIVATE_IndexedDbTargetCache(this.referenceDelegate, this.serializer), this.remoteDocumentCache = __PRIVATE_newIndexedDbRemoteDocumentCache(this.serializer), this.$r = new __PRIVATE_IndexedDbBundleCache(), this.window && this.window.localStorage ? this.di = this.window.localStorage : (this.di = null, false === u && __PRIVATE_logError("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
  }
  /**
  ...
  start() {
    return this.Ai().then(() => {
      if (!this.isPrimary && !this.allowTabSynchronization)
        throw new FirestoreError(D2.FAILED_PRECONDITION, Ae);
   ...
   */
    ...
    return this.Ii = (t) => __async(this, null, function* () {
      if (this.started)
        return e(t);
    }), e(this.isPrimary);
  }
  ...
  setDatabaseDeletedListener(e) {
    this.Ei.B((t) => __async(this, null, function* () {
  ...
  setNetworkEnabled(e) {
    ...
    this.oi.enqueueAndForget(() => __async(this, null, function* () {
      this.started && (yield this.Ai());
    })));
  }
  /**
  ...
  Ai() {
    return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (e) => __PRIVATE_clientMetadataStore(e).put({
      ...
      if (this.isPrimary)
        return this.gi(e).next((e2) => {
          e2 || (this.isPrimary = false, this.oi.enqueueRetryable(() => this.Ii(false)));
        });
    }).next(() => this.pi(e)).next((t) => this.isPrimary && !t ? this.yi(e).next(() => false) : !!t && this.wi(e).next(() => true))).catch((e) => {
  ...
  gi(e) {
    return __PRIVATE_primaryClientStore(e).get("owner").next((e2) => PersistencePromise.resolve(this.Si(e2)));
  }
  bi(e) {
  ...
  pi(e) {
    ...
    return __PRIVATE_primaryClientStore(e).get("owner").next((t) => {
      if (null !== t && this.Ci(t.leaseTimestampMs, 5e3) && !this.Mi(t.ownerId)) {
        if (this.Si(t) && this.networkEnabled)
          return true;
        if (!this.Si(t)) {
      ...
      return !(!this.networkEnabled || !this.inForeground) || __PRIVATE_clientMetadataStore(e).W().next((e2) => void 0 === this.vi(e2, 5e3).find((e3) => {
  ...
  shutdown() {
    return __async(this, null, function* () {
      ...
      yield this.Ei.runTransaction("shutdown", "readwrite", ["owner", "clientMetadata"], (e) => {
   ...
   */
  vi(e, t) {
    return e.filter((e2) => this.Ci(e2.updateTimeMs, t) && !this.Mi(e2.clientId));
  }
  /**
   ...
   */
  Bi() {
    return this.runTransaction("getActiveClients", "readonly", (e) => __PRIVATE_clientMetadataStore(e).W().next((e2) => this.vi(e2, 18e5).map((e3) => e3.clientId)));
  }
  get started() {
    return this.qr;
  }
  ...
  runTransaction(e, t, n) {
    ...
    const r2 = "readonly" === t ? "readonly" : "readwrite", i = (
      ...
      function __PRIVATE_getObjectStores(e2) {
        return 16 === e2 ? ee : 15 === e2 ? X2 : 14 === e2 ? Z2 : 13 === e2 ? Y2 : 12 === e2 ? J2 : 11 === e2 ? H2 : void fail();
      }(this.ui)
    );
    let s;
    return this.Ei.runTransaction(e, r2, i, (r3) => (s = new __PRIVATE_IndexedDbTransaction(r3, this.kr ? this.kr.next() : __PRIVATE_ListenSequence._e), "readwrite-primary" === t ? this.gi(s).next((e2) => !!e2 || this.pi(s)).next((t2) => {
      if (!t2)
        throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = false, this.oi.enqueueRetryable(() => this.Ii(false)), new FirestoreError(D2.FAILED_PRECONDITION, v2);
      return n(s);
    }).next((e2) => this.wi(s).next(() => e2)) : this.ki(s).next(() => n(s)))).then((e2) => (s.raiseOnCommittedEvent(), e2));
  }
  /**
  ...
  ki(e) {
    return __PRIVATE_primaryClientStore(e).get("owner").next((e2) => {
      if (null !== e2 && this.Ci(e2.leaseTimestampMs, 5e3) && !this.Mi(e2.ownerId) && !this.Si(e2) && !(this.ai || this.allowTabSynchronization && e2.allowTabSynchronization))
        throw new FirestoreError(D2.FAILED_PRECONDITION, Ae);
    });
  }
  /**
  ...
  yi(e) {
    ...
    return t.get("owner").next((e2) => this.Si(e2) ? (__PRIVATE_logDebug("IndexedDbPersistence", "Releasing primary lease."), t.delete("owner")) : PersistencePromise.resolve());
  }
...
function __PRIVATE_localStoreAllocateTarget(e, t) {
  ...
  return n.persistence.runTransaction("Allocate target", "readwrite", (e2) => {
    ...
    const r2 = n.ns.get(e2.targetId);
    return (null === r2 || e2.snapshotVersion.compareTo(r2.snapshotVersion) > 0) && (n.ns = n.ns.insert(e2.targetId, e2), n.rs.set(t, e2.targetId)), e2;
  });
}
function __PRIVATE_localStoreReleaseTarget(e, t, n) {
  return __async(this, null, function* () {
    const r2 = __PRIVATE_debugCast(e), i = r2.ns.get(t), s = n ? "readwrite" : "readwrite-primary";
    try {
    ...
    r2.ns = r2.ns.remove(t), r2.rs.delete(i.target);
  });
}
function __PRIVATE_localStoreExecuteQuery(e, t, n) {
  ...
  return r2.persistence.runTransaction(
    ...
    (e2) => function __PRIVATE_localStoreGetTargetData(e3, t2, n2) {
      const r3 = __PRIVATE_debugCast(e3), i2 = r3.rs.get(n2);
      return void 0 !== i2 ? PersistencePromise.resolve(r3.ns.get(i2)) : r3.Qr.getTargetData(t2, n2);
    ...
    }).next(() => r2.ts.getDocumentsMatchingQuery(e2, t, n ? i : SnapshotVersion.min(), n ? s : __PRIVATE_documentKeySet())).next((e3) => (__PRIVATE_setMaxReadTime(r2, __PRIVATE_queryCollectionGroup(t), e3), {
      documents: e3,
      hs: s
    }))
  );
...
function __PRIVATE_localStoreGetCachedTarget(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = __PRIVATE_debugCast(n.Qr), i = n.ns.get(t);
...
function __PRIVATE_localStoreGetNewDocumentChanges(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = n.ss.get(t) || SnapshotVersion.min();
  return n.persistence.runTransaction("Get new document changes", "readonly", (e2) => n.os.getAllFromCollectionGroup(
    e2,
    t,
...
function __PRIVATE_setMaxReadTime(e, t, n) {
  let r2 = e.ss.get(t) || SnapshotVersion.min();
  n.forEach((e2, t2) => {
...
function __PRIVATE_localStoreApplyBundledDocuments(e, t, n, r2) {
  return __async(this, null, function* () {
    ...
    for (const e2 of n) {
      ...
      const r3 = t.Is(e2);
      r3.setReadTime(t.Ts(e2.metadata.readTime)), o = o.insert(n2, r3);
    }
    ...
    return i.persistence.runTransaction("Apply bundle documents", "readwrite", (e2) => __PRIVATE_populateDocumentChangeBuffer(e2, _, o).next((t2) => (_.apply(e2), t2)).next((t2) => i.Qr.removeMatchingKeysForTargetId(e2, a.targetId).next(() => i.Qr.addMatchingKeys(e2, s, a.targetId)).next(() => i.localDocuments.getLocalViewOfDocuments(e2, t2.cs, t2.ls)).next(() => t2.cs)));
  });
}
  ...
  return __async(this, arguments, function* (e, t, n = __PRIVATE_documentKeySet()) {
    ...
    return i.persistence.runTransaction("Save named query", "readwrite", (e2) => {
      ...
      if (r2.snapshotVersion.compareTo(s) >= 0)
        return i.$r.saveNamedQuery(e2, t);
      const o = r2.withResumeToken(ByteString.EMPTY_BYTE_STRING, s);
      return i.ns = i.ns.insert(o.targetId, o), i.Qr.updateTargetData(e2, o).next(() => i.Qr.removeMatchingKeysForTargetId(e2, r2.targetId)).next(() => i.Qr.addMatchingKeys(e2, n, r2.targetId)).next(() => i.$r.saveNamedQuery(e2, t));
    });
  });
}
...
var __PRIVATE_WebStorageSharedClientState = class {
  constructor(e, t, n, r2, i) {
    this.window = e, this.oi = t, this.persistenceKey = n, this.Vs = r2, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.fs = this.gs.bind(this), this.ps = new SortedMap(__PRIVATE_primitiveComparator), this.started = false, /**
    ...
    }(this.persistenceKey), this.Fs = function createBundleLoadedKey(e2) {
  ...
  start() {
    return __async(this, null, function* () {
      ...
      for (const t2 of e) {
        ...
        if (e2) {
          const n = __PRIVATE_RemoteClientState.Es(t2, e2);
      ...
      for (const e2 of this.ys)
        this.gs(e2);
      this.ys = [], // Register a window unload hook to remove the client metadata entry from
  ...
  updateMutationState(e, t, n) {
    this.Ls(e, t, n), // Once a final mutation result is observed by other clients, they no longer
  ...
  addLocalQueryTarget(e) {
    ...
    if (this.isActiveQueryTarget(e)) {
      ...
      if (n) {
        const r2 = __PRIVATE_QueryTargetMetadata.Es(e, n);
        r2 && (t = r2.state);
      }
    }
  ...
  shutdown() {
    this.started && (this.window.removeEventListener("storage", this.fs), this.removeItem(this.ws), this.started = false);
  }
  getItem(e) {
  ...
  gs(e) {
    ...
    if (t.storageArea === this.storage) {
      if (__PRIVATE_logDebug("SharedClientState", "EVENT", t.key, t.newValue), t.key === this.ws)
      ...
      this.oi.enqueueRetryable(() => __async(this, null, function* () {
        if (this.started) {
          if (null !== t.key) {
            if (this.bs.test(t.key)) {
              if (null == t.newValue) {
                const e2 = this.$s(t.key);
                return this.Us(e2, null);
              }
              {
                const e2 = this.Ws(t.key, t.newValue);
                if (e2)
                  return this.Us(e2.clientId, e2);
              }
            } else if (this.Ds.test(t.key)) {
              if (null !== t.newValue) {
                const e2 = this.Gs(t.key, t.newValue);
                if (e2)
                  return this.zs(e2);
              }
              ...
              const e2 = this.Js(t.newValue);
              yield Promise.all(e2.map((e3) => this.syncEngine.Ys(e3)));
            }
          }
        } else
          this.ys.push(t);
   ...
   */
  Gs(e, t) {
    const n = this.Ds.exec(e), r2 = Number(n[1]), i = void 0 !== n[2] ? n[2] : null;
    return __PRIVATE_MutationMetadata.Es(new User(i), r2, t);
  }
  /**
   ...
   */
  js(e, t) {
    const n = this.Cs.exec(e), r2 = Number(n[1]);
    return __PRIVATE_QueryTargetMetadata.Es(r2, t);
  }
  /**
  ...
  Us(e, t) {
    const n = t ? this.ps.insert(e, t) : this.ps.remove(e), r2 = this.Ns(this.ps), i = this.Ns(n), s = [], o = [];
    return i.forEach((e2) => {
      r2.has(e2) || s.push(e2);
    }), r2.forEach((e2) => {
      i.has(e2) || o.push(e2);
...
class __PRIVATE_RestConnection {
        ...
        try {
          switch (_.getLastErrorCode()) {
            ...
            case ErrorCode.TIMEOUT:
              __PRIVATE_logDebug(me, `RPC '${e}' ${i} timed out`), o(new FirestoreError(D2.DEADLINE_EXCEEDED, "Request time out"));
              break;
  ...
  Fo(e, t, n) {
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      h || (h = true, __PRIVATE_logDebug(me, `RPC '${e}' stream ${r2} transport closed`), P2.Vo());
    }), __PRIVATE_unguardedEventListen(c, WebChannel.EventType.ERROR, (t2) => {
      h || (h = true, __PRIVATE_logWarn(me, `RPC '${e}' stream ${r2} transport errored:`, t2), P2.Vo(new FirestoreError(D2.UNAVAILABLE, "The operation could not be completed")));
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          __PRIVATE_logDebug(me, `RPC '${e}' stream ${r2} received:`, i2), P2.mo(i2);
      }
...
var __PRIVATE_PersistentStream = class {
  ...
  Yo() {
    this.state = 5, this.jo.qo(() => __async(this, null, function* () {
...
var __PRIVATE_PersistentListenStream = class extends __PRIVATE_PersistentStream {
  ...
  c_(e) {
    ...
    t.database = __PRIVATE_getEncodedDatabaseId(this.serializer), t.addTarget = function __PRIVATE_toTarget(e2, t2) {
      ...
      if (n2 = __PRIVATE_targetIsDocumentTarget(r2) ? {
        ...
        query: __PRIVATE_toQueryTarget(e2, r2).ut
  ...
  l_(e) {
    const t = {};
    t.database = __PRIVATE_getEncodedDatabaseId(this.serializer), t.removeTarget = e, this.t_(t);
  }
};
      ...
      n.enqueueAndForget(() => __async(this, null, function* () {
        __PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug("RemoteStore", "Restarting streams for network reachability change."), yield function __PRIVATE_restartNetwork(e3) {
          return __async(this, null, function* () {
            ...
            ), yield __PRIVATE_disableNetworkInternal(t2), t2.x_.set(
              "Unknown"
              /* OnlineState.Unknown */
            ), t2.v_.delete(
              4
...
function __PRIVATE_remoteStoreListen(e, t) {
  ...
  (n.C_.set(t.targetId, t), __PRIVATE_shouldStartWatchStream(n) ? (
    // The listen will be sent in onWatchStreamOpen
    __PRIVATE_startWatchStream(n)
  ) : __PRIVATE_ensureWatchStream(n).Jo() && __PRIVATE_sendWatchRequest(n, t));
}
function __PRIVATE_remoteStoreUnlisten(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = __PRIVATE_ensureWatchStream(n);
  n.C_.delete(t), r2.Jo() && __PRIVATE_sendUnwatchRequest(n, t), 0 === n.C_.size && (r2.Jo() ? r2.Xo() : __PRIVATE_canUseNetwork(n) && // Revert to OnlineState.Unknown if the watch stream is not open and we
...
function __PRIVATE_sendWatchRequest(e, t) {
  if (e.O_.Oe(t.targetId), t.resumeToken.approximateByteSize() > 0 || t.snapshotVersion.compareTo(SnapshotVersion.min()) > 0) {
    const n = e.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;
    t = t.withExpectedCount(n);
  }
  __PRIVATE_ensureWatchStream(e).c_(t);
}
function __PRIVATE_sendUnwatchRequest(e, t) {
  e.O_.Oe(t), __PRIVATE_ensureWatchStream(e).l_(t);
}
function __PRIVATE_startWatchStream(e) {
  e.O_ = new __PRIVATE_WatchChangeAggregator({
    getRemoteKeysForTarget: (t) => e.remoteSyncer.getRemoteKeysForTarget(t),
    _t: (t) => e.C_.get(t) || null,
    nt: () => e.datastore.serializer.databaseId
  }), __PRIVATE_ensureWatchStream(e).start(), e.x_.p_();
}
function __PRIVATE_shouldStartWatchStream(e) {
  return __PRIVATE_canUseNetwork(e) && !__PRIVATE_ensureWatchStream(e).Ho() && e.C_.size > 0;
}
...
function __PRIVATE_onWatchStreamClose(e, t) {
  return __async(this, null, function* () {
    ...
    __PRIVATE_shouldStartWatchStream(e) ? (e.x_.S_(t), __PRIVATE_startWatchStream(e)) : (
...
function __PRIVATE_onWatchStreamChange(e, t, n) {
  return __async(this, null, function* () {
          ...
          function __PRIVATE_handleTargetError(e2, t2) {
            return __async(this, null, function* () {
              ...
              for (const r2 of t2.targetIds)
                e2.C_.has(r2) && (yield e2.remoteSyncer.rejectListen(r2, n2), e2.C_.delete(r2), e2.O_.removeTarget(r2));
            });
          }(e, t)
        );
      } catch (n2) {
    ...
    else if (t instanceof __PRIVATE_DocumentWatchChange ? e.O_.$e(t) : t instanceof __PRIVATE_ExistenceFilterChange ? e.O_.Je(t) : e.O_.Ge(t), !n.isEqual(SnapshotVersion.min()))
      try {
        ...
        (yield (
          ...
          */
          function __PRIVATE_raiseWatchSnapshot(e2, t3) {
            const n2 = e2.O_.it(t3);
            return n2.targetChanges.forEach((n3, r2) => {
              if (n3.resumeToken.approximateByteSize() > 0) {
                const i = e2.C_.get(r2);
                i && e2.C_.set(r2, i.withResumeToken(n3.resumeToken, t3));
              }
            }), // Re-establish listens for the targets that have been invalidated by
            // existence filter mismatches.
            n2.targetMismatches.forEach((t4, n3) => {
              const r2 = e2.C_.get(t4);
              if (!r2)
                return;
              e2.C_.set(t4, r2.withResumeToken(ByteString.EMPTY_BYTE_STRING, r2.snapshotVersion)), // Cause a hard reset by unwatching and rewatching immediately, but
...
function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
  return __async(this, null, function* () {
    ...
    yield __PRIVATE_disableNetworkInternal(e), e.x_.set(
      "Offline"
      /* OnlineState.Offline */
    ...
    e.asyncQueue.enqueueRetryable(() => __async(this, null, function* () {
      __PRIVATE_logDebug("RemoteStore", "Retrying IndexedDB access"), yield n(), e.v_.delete(
        1
        /* OfflineCause.IndexedDbFailed */
    ...
    (yield function __PRIVATE_handleWriteError(e2, t2) {
      return __async(this, null, function* () {
        if (function __PRIVATE_isPermanentWriteError(e3) {
          ...
          const n = e2.D_.shift();
          __PRIVATE_ensureWriteStream(e2).Zo(), yield __PRIVATE_executeWithRecovery(e2, () => e2.remoteSyncer.rejectFailedWrite(n.batchId, t2)), // It's possible that with the completion of this mutation
...
function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
  return __async(this, null, function* () {
    ...
    n.x_.set(
      "Unknown"
      /* OnlineState.Unknown */
    ), yield n.remoteSyncer.handleCredentialChange(t), n.v_.delete(
      3
      /* OfflineCause.CredentialChange */
...
function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
  return __async(this, null, function* () {
    ...
    ), yield __PRIVATE_enableNetworkInternal(n)) : t || (n.v_.add(
      2
      /* OfflineCause.IsSecondary */
    ), yield __PRIVATE_disableNetworkInternal(n), n.x_.set(
      "Unknown"
      /* OnlineState.Unknown */
    ));
  });
...
function __PRIVATE_ensureWatchStream(e) {
  ...
  (e.N_ = function __PRIVATE_newPersistentWatchStream(e2, t, n) {
    const r2 = __PRIVATE_debugCast(e2);
    return r2.R_(), new __PRIVATE_PersistentListenStream(t, r2.connection, r2.authCredentials, r2.appCheckCredentials, r2.serializer, n);
  }(e.datastore, e.asyncQueue, {
    Po: __PRIVATE_onWatchStreamOpen.bind(null, e),
    To: __PRIVATE_onWatchStreamClose.bind(null, e),
    u_: __PRIVATE_onWatchStreamChange.bind(null, e)
  }), e.F_.push((t) => __async(this, null, function* () {
    t ? (e.N_.Zo(), __PRIVATE_shouldStartWatchStream(e) ? __PRIVATE_startWatchStream(e) : e.x_.set(
      "Unknown"
      /* OnlineState.Unknown */
    )) : (yield e.N_.stop(), __PRIVATE_cleanUpWatchStreamState(e));
  }))), e.N_;
}
function __PRIVATE_ensureWriteStream(e) {
  ...
  (e.L_ = function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    ...
    yield __PRIVATE_fillWritePipeline(e)) : (yield e.L_.stop(), e.D_.length > 0 && (__PRIVATE_logDebug("RemoteStore", `Stopping write stream with ${e.D_.length} pending writes`), e.D_ = []));
  }))), e.L_;
}
...
function __PRIVATE_eventManagerListen(e, t) {
  return __async(this, null, function* () {
    ...
    s ? !s.K_() && t.U_() && // Query has been listening to local cache, and tries to add a new listener sourced from watch.
    (r2 = 2) : (s = new __PRIVATE_QueryListenersInfo(), r2 = t.U_() ? 0 : 1);
    try {
      switch (r2) {
        case 0:
          s.q_ = yield n.onListen(
            i,
            /** enableRemoteListen= */
            true
          );
    ...
    if (n.queries.set(i, s), s.Q_.push(t), // Run global snapshot listeners if a consistent snapshot has been emitted.
    t.G_(n.onlineState), s.q_) {
      t.z_(s.q_) && __PRIVATE_raiseSnapshotsInSyncEvent(n);
    }
  });
}
function __PRIVATE_eventManagerUnlisten(e, t) {
  return __async(this, null, function* () {
    ...
    if (s) {
      const e2 = s.Q_.indexOf(t);
      e2 >= 0 && (s.Q_.splice(e2, 1), 0 === s.Q_.length ? i = t.U_() ? 0 : 1 : !s.K_() && t.U_() && // The removed listener is the last one that sourced from watch.
      (i = 2));
    }
    switch (i) {
      case 0:
...
var fe;
var ge;
(ge = fe || (fe = {})).j_ = "default", /** Listen to changes in cache only */
ge.Cache = "cache";
var __PRIVATE_QueryListener = class {
  constructor(e, t, n) {
    this.query = e, this.H_ = t, /**
     * Initial snapshots (e.g. from cache) may not be propagated to the wrapped
     * observer. This flag is set to true once we've actually raised an event.
     */
    this.J_ = false, this.Y_ = null, this.onlineState = "Unknown", this.options = n || {};
  }
  /**
  ...
  z_(e) {
    ...
    let t = false;
    return this.J_ ? this.Z_(e) && (this.H_.next(e), t = true) : this.X_(e, this.onlineState) && (this.ea(e), t = true), this.Y_ = e, t;
  }
  onError(e) {
    this.H_.error(e);
  }
  ...
  G_(e) {
    this.onlineState = e;
    let t = false;
    return this.Y_ && !this.J_ && this.X_(this.Y_, e) && (this.ea(this.Y_), t = true), t;
  }
  X_(e, t) {
    if (!e.fromCache)
      return true;
  ...
  ea(e) {
    e = ViewSnapshot.fromInitialDocuments(e.query, e.docs, e.mutatedKeys, e.fromCache, e.hasCachedResults), this.J_ = true, this.H_.next(e);
  }
  U_() {
...
var __PRIVATE_BundleConverterImpl = class {
   ...
   */
  Is(e) {
    return e.metadata.exists ? __PRIVATE_fromDocument(this.serializer, e.document, false) : MutableDocument.newNoDocument(this.Ps(e.metadata.name), this.Ts(e.metadata.readTime));
  }
  Ts(e) {
...
var __PRIVATE_BundleLoader = class {
  constructor(e, t, n) {
    this.ia = e, this.localStore = t, this.serializer = n, /** Batched queries to be saved into storage */
  ...
  sa(e) {
    ...
    if (e.na.namedQuery)
      this.queries.push(e.na.namedQuery);
    else if (e.na.documentMetadata) {
      this.documents.push({
        metadata: e.na.documentMetadata
      }), e.na.documentMetadata.exists || ++t;
      const n = ResourcePath.fromString(e.na.documentMetadata.name);
      this.collectionGroups.add(n.get(n.length - 2));
    } else
      e.na.document && (this.documents[this.documents.length - 1].document = e.na.document, ++t);
  ...
  complete() {
    return __async(this, null, function* () {
      const e = yield __PRIVATE_localStoreApplyBundledDocuments(this.localStore, new __PRIVATE_BundleConverterImpl(this.serializer), this.documents, this.ia.id), t = this.oa(this.documents);
...
var __PRIVATE_View = class {
  constructor(e, t) {
    this.query = e, this.ua = t, this.ca = null, this.hasCachedResults = false, /**
    ...
    this.la = __PRIVATE_documentKeySet(), /** Document Keys that have local changes */
    this.mutatedKeys = __PRIVATE_documentKeySet(), this.ha = __PRIVATE_newQueryComparator(e), this.Pa = new DocumentSet(this.ha);
  }
  /**
   ...
   */
  Ta(e, t) {
    const n = t ? t.Ea : new __PRIVATE_DocumentChangeSet(), r2 = t ? t.Pa : this.Pa;
    ...
    if (e.inorderTraversal((e2, t2) => {
      ...
      if (u && c) {
        u.data.isEqual(c.data) ? l2 !== h && (n.track({
          type: 3,
          doc: c
        }), P2 = true) : this.da(u, c) || (n.track({
          type: 2,
          doc: c
        }), P2 = true, (_ && this.ha(c, _) > 0 || a && this.ha(c, a) < 0) && // This doc moved from inside the limit to outside the limit.
  ...
  applyChanges(e, t, n, r2) {
    ...
    }(e2.type, t2.type) || this.ha(e2.doc, t2.doc)), this.Aa(n), r2 = null != r2 && r2;
    const o = t && !r2 ? this.Ra() : [], _ = 0 === this.la.size && this.current && !r2 ? 1 : 0, a = _ !== this.ca;
    if (this.ca = _, 0 !== s.length || a) {
      return {
   ...
   */
  ma(e) {
    return !this.ua.has(e) && // The local store doesn't think it's a result, so it shouldn't be in limbo.
    (!!this.Pa.has(e) && !this.Pa.get(e).hasLocalMutations);
  }
  /**
   ...
   */
  Aa(e) {
    e && (e.addedDocuments.forEach((e2) => this.ua = this.ua.add(e2)), e.modifiedDocuments.forEach((e2) => {
    }), e.removedDocuments.forEach((e2) => this.ua = this.ua.delete(e2)), this.current = e.current);
  }
  Ra() {
    if (!this.current)
      return [];
    const e = this.la;
    this.la = __PRIVATE_documentKeySet(), this.Pa.forEach((e2) => {
      this.ma(e2.key) && (this.la = this.la.add(e2.key));
    });
    const t = [];
    return e.forEach((e2) => {
      this.la.has(e2) || t.push(new __PRIVATE_RemovedLimboDocument(e2));
    }), this.la.forEach((n) => {
  ...
  // PORTING NOTE: Multi-tab only.
  fa(e) {
    this.ua = e.hs, this.la = __PRIVATE_documentKeySet();
  ...
  // PORTING NOTE: Multi-tab only.
  ga() {
    return ViewSnapshot.fromInitialDocuments(this.query, this.Pa, this.mutatedKeys, 0 === this.ca, this.hasCachedResults);
  }
};
...
function __PRIVATE_syncEngineListen(e, t, n = true) {
  return __async(this, null, function* () {
    ...
    return s ? (
      ...
      (r2.sharedClientState.addLocalQueryTarget(s.targetId), i = s.view.ga())
...
function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r2, i) {
  return __async(this, null, function* () {
    e.Na = (t2, n2, r3) => function __PRIVATE_applyDocChanges(e2, t3, n3, r4) {
      return __async(this, null, function* () {
        let i2 = t3.view.Ta(n3);
        i2.Xi && // The query has a limit and some docs were removed, so we need
        ...
        (i2 = yield __PRIVATE_localStoreExecuteQuery(
          ...
          /* usePreviousResults= */
          false
        ).then(({ documents: e3 }) => t3.view.Ta(e3, i2)));
        ...
        return __PRIVATE_updateTrackedLimbos(e2, t3.targetId, _2.Va), _2.snapshot;
      });
    }(e, t2, n2, r3);
    const s = yield __PRIVATE_localStoreExecuteQuery(
      ...
      /* usePreviousResults= */
      true
    ), o = new __PRIVATE_View(t, s.hs), _ = o.Ta(s.documents), a = TargetChange.createSynthesizedTargetChangeForCurrentChange(n, r2 && "Offline" !== e.onlineState, i), u = o.applyChanges(
      _,
      /* limboResolutionEnabled= */
      e.isPrimaryClient,
      a
    );
    __PRIVATE_updateTrackedLimbos(e, n, u.Va);
    const c = new __PRIVATE_QueryView(t, n, o);
    return e.wa.set(t, c), e.Sa.has(n) ? e.Sa.get(n).push(t) : e.Sa.set(n, [t]), u.snapshot;
  });
}
function __PRIVATE_syncEngineUnlisten(e, t, n) {
  return __async(this, null, function* () {
    const r2 = __PRIVATE_debugCast(e), i = r2.wa.get(t), s = r2.Sa.get(i.targetId);
    if (s.length > 1)
      return r2.Sa.set(i.targetId, s.filter((e2) => !__PRIVATE_queryEquals(e2, t))), void r2.wa.delete(t);
...
function __PRIVATE_triggerRemoteStoreUnlisten(e, t) {
  return __async(this, null, function* () {
    const n = __PRIVATE_debugCast(e), r2 = n.wa.get(t), i = n.Sa.get(r2.targetId);
  ...
  return __async(this, null, function* () {
    ...
    try {
      ...
      t.targetChanges.forEach((e3, t2) => {
        const r2 = n.Ca.get(t2);
        r2 && // Since this is a limbo resolution lookup, it's for a single document
        // and it could be added, modified, or removed, but not a combination.
        (__PRIVATE_hardAssert(e3.addedDocuments.size + e3.modifiedDocuments.size + e3.removedDocuments.size <= 1), e3.addedDocuments.size > 0 ? r2.pa = true : e3.modifiedDocuments.size > 0 ? __PRIVATE_hardAssert(r2.pa) : e3.removedDocuments.size > 0 && (__PRIVATE_hardAssert(r2.pa), r2.pa = false));
...
function __PRIVATE_syncEngineRejectListen(e, t, n) {
  return __async(this, null, function* () {
    ...
    if (s) {
      ...
      r2.Da = r2.Da.remove(s), r2.Ca.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r2);
    } else
...
function __PRIVATE_syncEngineRegisterPendingWritesCallback(e, t) {
  return __async(this, null, function* () {
    ...
    try {
      ...
      const r2 = n.Ma.get(e2) || [];
      r2.push(t), n.Ma.set(e2, r2);
    } catch (e2) {
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  ...
  for (const r2 of e.Sa.get(t))
    e.wa.delete(r2), n && e.ya.La(r2, n);
  if (e.Sa.delete(t), e.isPrimaryClient) {
    e.va.Vr(t).forEach((t2) => {
      e.va.containsKey(t2) || // We removed the last reference for this key
...
function __PRIVATE_removeLimboTarget(e, t) {
  ...
  const n = e.Da.get(t);
  null !== n && (__PRIVATE_remoteStoreUnlisten(e.remoteStore, n), e.Da = e.Da.remove(t), e.Ca.delete(n), __PRIVATE_pumpEnqueuedLimboResolutions(e));
}
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r2 of n)
    if (r2 instanceof __PRIVATE_AddedLimboDocument)
      e.va.addReference(r2.key, t), __PRIVATE_trackLimboChange(e, r2);
    else if (r2 instanceof __PRIVATE_RemovedLimboDocument) {
      __PRIVATE_logDebug("SyncEngine", "Document no longer in limbo: " + r2.key), e.va.removeReference(r2.key, t);
      e.va.containsKey(r2.key) || // We removed the last reference for this key
...
function __PRIVATE_trackLimboChange(e, t) {
  ...
  e.Da.get(n) || e.ba.has(r2) || (__PRIVATE_logDebug("SyncEngine", "New document in limbo: " + n), e.ba.add(r2), __PRIVATE_pumpEnqueuedLimboResolutions(e));
}
function __PRIVATE_pumpEnqueuedLimboResolutions(e) {
  for (; e.ba.size > 0 && e.Da.size < e.maxConcurrentLimboResolutions; ) {
    const t = e.ba.values().next().value;
    e.ba.delete(t);
    const n = new DocumentKey(ResourcePath.fromString(t)), r2 = e.xa.next();
    e.Ca.set(r2, new LimboResolution(n)), e.Da = e.Da.insert(n, r2), __PRIVATE_remoteStoreListen(e.remoteStore, new TargetData(__PRIVATE_queryToTarget(__PRIVATE_newQueryForPath(n.path)), r2, "TargetPurposeLimboResolution", __PRIVATE_ListenSequence._e));
  }
}
function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
  return __async(this, null, function* () {
    ...
    }), yield Promise.all(o), r2.ya.u_(i), yield function __PRIVATE_localStoreNotifyLocalViewChanges(e2, t2) {
      return __async(this, null, function* () {
...
function __PRIVATE_syncEngineHandleCredentialChange(e, t) {
  return __async(this, null, function* () {
    ...
    if (!n.currentUser.isEqual(t)) {
      ...
      n.sharedClientState.handleUserChange(t, e2.removedBatchIds, e2.addedBatchIds), yield __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(n, e2.us);
    }
  });
}
function __PRIVATE_syncEngineGetRemoteKeysForTarget(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = n.Ca.get(t);
  if (r2 && r2.pa)
...
function __PRIVATE_synchronizeViewAndComputeSnapshot(e, t) {
  return __async(this, null, function* () {
    ...
    return n.isPrimaryClient && __PRIVATE_updateTrackedLimbos(n, t.targetId, i.Va), i;
  });
}
  ...
  return __async(this, null, function* () {
    ...
    null !== s ? ("pending" === n ? (
      ...
      (__PRIVATE_processUserCallback(i, t, r2 || null), __PRIVATE_triggerPendingWritesCallbacks(i, t), function __PRIVATE_localStoreRemoveCachedMutationBatchMetadata(e2, t2) {
        __PRIVATE_debugCast(__PRIVATE_debugCast(e2).mutationQueue).Mn(t2);
      }(i.localStore, t))
...
function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
  return __async(this, null, function* () {
    const n = __PRIVATE_debugCast(e);
    if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), true === t && true !== n.Oa) {
      ...
      n.Oa = true, yield __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, true);
      for (const e3 of t2)
        __PRIVATE_remoteStoreListen(n.remoteStore, e3);
    } else if (false === t && false !== n.Oa) {
      const e2 = [];
      ...
      function __PRIVATE_resetLimboDocuments(e3) {
        ...
        }), t3.va.mr(), t3.Ca = /* @__PURE__ */ new Map(), t3.Da = new SortedMap(DocumentKey.comparator);
      }(n), n.Oa = false, yield __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, false);
    }
  });
}
function __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(e, t, n) {
  return __async(this, null, function* () {
    ...
    for (const e2 of t) {
      let t2;
      const n2 = r2.Sa.get(e2);
      if (n2 && 0 !== n2.length) {
        t2 = yield __PRIVATE_localStoreAllocateTarget(r2.localStore, __PRIVATE_queryToTarget(n2[0]));
        for (const e3 of n2) {
          const t3 = r2.wa.get(e3), n3 = yield __PRIVATE_synchronizeViewAndComputeSnapshot(r2, t3);
...
function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
  return __async(this, null, function* () {
    ...
    if (r2.Oa) {
      for (const e2 of t) {
        if (r2.Sa.has(e2) && r2.sharedClientState.isActiveQueryTarget(e2)) {
      ...
      for (const e2 of n)
        r2.Sa.has(e2) && // Release queries that are still active.
        (yield __PRIVATE_localStoreReleaseTarget(
          r2.localStore,
          e2,
          /* keepPersistedTargetData */
    ...
    return __async(this, null, function* () {
      try {
        ...
        if (yield function __PRIVATE_localStoreHasNewerBundle(e3, t3) {
          ...
          return n3.persistence.runTransaction("hasNewerBundle", "readonly", (e4) => n3.$r.getBundleMetadata(e4, t3.id)).then((e4) => !!e4 && e4.createTime.compareTo(r4) >= 0);
        }(e2.localStore, r3))
        ...
        let s = yield t2.Ba();
        for (; s; ) {
          const e3 = yield i.sa(s);
          e3 && n2._updateProgress(e3), s = yield t2.Ba();
        }
        ...
        yield function __PRIVATE_localStoreSaveBundle(e3, t3) {
          ...
          return n3.persistence.runTransaction("Save bundle", "readwrite", (e4) => n3.$r.saveBundleMetadata(e4, t3));
        }(e2.localStore, r3), n2._completeWith(o.progress), Promise.resolve(o._a);
      } catch (e3) {
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class ___PRIVATE_IndexedDbOfflineComponentProvider extends MemoryOfflineComponentProvider {
  constructor(e, t, n) {
    super(), this.ka = e, this.cacheSizeBytes = t, this.forceOwnership = n, this.synchronizeTabs = false;
  }
  initialize(e) {
    return __async(this, null, function* () {
      yield __superGet(___PRIVATE_IndexedDbOfflineComponentProvider.prototype, this, "initialize").call(this, e), yield this.ka.initialize(this, e), // Enqueue writes from a previous session
      yield __PRIVATE_syncEngineEnsureWriteCallbacks(this.ka.syncEngine), yield __PRIVATE_fillWritePipeline(this.ka.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
      // set it after localStore / remoteStore are started.
      yield this.persistence.fi(() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve()));
    });
  }
  createLocalStore(e) {
    return __PRIVATE_newLocalStore(this.persistence, new __PRIVATE_QueryEngine(), e.initialUser, this.serializer);
...
var __PRIVATE_MultiTabOfflineComponentProvider = class ___PRIVATE_MultiTabOfflineComponentProvider extends __PRIVATE_IndexedDbOfflineComponentProvider {
  ...
  initialize(e) {
    return __async(this, null, function* () {
      ...
      // set it after localStore / remoteStore are started.
      yield this.persistence.fi((e2) => __async(this, null, function* () {
        yield __PRIVATE_syncEngineApplyPrimaryState(this.ka.syncEngine, e2), this.gcScheduler && (e2 && !this.gcScheduler.started ? this.gcScheduler.start() : e2 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e2 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e2 || this.indexBackfillerScheduler.stop());
      }));
    });
  }
  createSharedClientState(e) {
    ...
    return __async(this, null, function* () {
      ...
      yield function __PRIVATE_remoteStoreShutdown(e2) {
        return __async(this, null, function* () {
          ...
          ), yield __PRIVATE_disableNetworkInternal(t), t.M_.shutdown(), // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
...
var __PRIVATE_AsyncObserver = class {
  ...
  error(e) {
    this.observer.error ? this.qa(this.observer.error, e) : __PRIVATE_logError("Uncaught Error in snapshot listener:", e.toString());
  }
  Qa() {
    this.muted = true;
  }
...
var __PRIVATE_BundleReaderImpl = class {
  constructor(e, t) {
    this.Ka = e, this.serializer = t, /** Cached bundle metadata. */
    this.metadata = new __PRIVATE_Deferred(), /**
     * Internal buffer to hold bundle content, accumulating incomplete element
     * content.
     */
    this.buffer = new Uint8Array(), this.$a = function __PRIVATE_newTextDecoder() {
      return new TextDecoder("utf-8");
    }(), // Read the metadata (which is the first element).
    this.Ua().then((e2) => {
      e2 && e2.ra() ? this.metadata.resolve(e2.na.metadata) : this.metadata.reject(new Error(`The first element of the bundle is not a metadata, it is
             ${JSON.stringify(null == e2 ? void 0 : e2.na)}`));
  ...
  Ba() {
    return __async(this, null, function* () {
      return yield this.getMetadata(), this.Ua();
    });
  }
  /**
  ...
  Ua() {
    return __async(this, null, function* () {
      const e = yield this.Wa();
      if (null === e)
        return null;
      const t = this.$a.decode(e), n = Number(t);
      isNaN(n) && this.Ga(`length string (${t}) is not valid number`);
      const r2 = yield this.za(n);
  ...
  za(e) {
    return __async(this, null, function* () {
      for (; this.buffer.length < e; ) {
        (yield this.Ha()) && this.Ga("Reached the end of bundle when more is expected.");
      }
      const t = this.$a.decode(this.buffer.slice(0, e));
      return this.buffer = this.buffer.slice(e), t;
    });
  }
  Ga(e) {
  ...
  lookup(e) {
    return __async(this, null, function* () {
      if (this.ensureCommitNotCalled(), this.mutations.length > 0)
        throw this.lastTransactionError = new FirestoreError(D2.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes."), this.lastTransactionError;
      const t = yield function __PRIVATE_invokeBatchGetDocumentsRpc(e2, t2) {
        return __async(this, null, function* () {
          ...
          }, i = yield n.vo("BatchGetDocuments", n.serializer.databaseId, ResourcePath.emptyPath(), r2, t2.length), s = /* @__PURE__ */ new Map();
          i.forEach((e3) => {
...
var __PRIVATE_TransactionRunner = class {
  constructor(e, t, n, r2, i) {
    this.asyncQueue = e, this.datastore = t, this.options = n, this.updateFunction = r2, this.deferred = i, this.Ja = n.maxAttempts, this.jo = new __PRIVATE_ExponentialBackoff(
      this.asyncQueue,
      "transaction_retry"
  ...
  Za() {
    this.jo.qo(() => __async(this, null, function* () {
      const e = new Transaction$2(this.datastore), t = this.Xa(e);
      t && t.then((t2) => {
  ...
  eu(e) {
    this.Ja > 0 && this.tu(e) ? (this.Ja -= 1, this.asyncQueue.enqueueAndForget(() => (this.Za(), Promise.resolve()))) : this.deferred.reject(e);
  }
  tu(e) {
      ...
      return __async(this, null, function* () {
        try {
          const r2 = yield __PRIVATE_localStoreExecuteQuery(
            ...
            /* usePreviousResults= */
            true
          ), i = new __PRIVATE_View(t2, r2.hs), s = i.Ta(r2.documents), o = i.applyChanges(
            s,
            /* limboResolutionEnabled= */
            false
          );
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(() => __async(this, null, function* () {
    return function __PRIVATE_addSnapshotsInSyncListener(e2, t2) {
      __PRIVATE_debugCast(e2).W_.add(t2), // Immediately fire an initial event, indicating all existing listeners
      // are in-sync.
      t2.next();
    }(yield __PRIVATE_getEventManager(e), n);
  })), () => {
    n.Qa(), e.asyncQueue.enqueueAndForget(() => __async(this, null, function* () {
      return function __PRIVATE_removeSnapshotsInSyncListener(e2, t2) {
        __PRIVATE_debugCast(e2).W_.delete(t2);
      }(yield __PRIVATE_getEventManager(e), n);
    }));
  };
}
...
function __PRIVATE_firestoreClientGetNamedQuery(e, t) {
  return e.asyncQueue.enqueue(() => __async(this, null, function* () {
    return function __PRIVATE_localStoreGetNamedQuery(e2, t2) {
      ...
      return n.persistence.runTransaction("Get named query", "readonly", (e3) => n.$r.getNamedQuery(e3, t2));
...
var Firestore$1 = class {
  ...
  _terminate() {
    return function __PRIVATE_removeComponents(e) {
      const t = pe.get(e);
      t && (__PRIVATE_logDebug("ComponentProvider", "Removing Datastore"), pe.delete(e), t.terminate());
...
var __PRIVATE_AsyncQueueImpl = class {
  ...
  Pu() {
    return __async(this, null, function* () {
      if (0 !== this.ru.length) {
        try {
          yield this.ru[0](), this.ru.shift(), this.jo.reset();
        } catch (e) {
          if (!__PRIVATE_isIndexedDbTransactionError(e))
            throw e;
...
var __PRIVATE_ParseContextImpl = class ___PRIVATE_ParseContextImpl {
  ...
  pu(e) {
    ...
    if (__PRIVATE_isWrite(this.Vu) && we.test(e))
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(e) {
    if (2 !== e.Vu)
      throw 1 === e.Vu ? e.Su(`${this._methodName}() can only appear at the top level of your update data`) : e.Su(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
var __PRIVATE_ArrayUnionFieldValueImpl = class ___PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), n = this.vu.map((e2) => __PRIVATE_parseData(e2, t)), r2 = new __PRIVATE_ArrayUnionTransformOperation(n);
    return new FieldTransform(e.path, r2);
  }
  isEqual(e) {
    return e instanceof ___PRIVATE_ArrayUnionFieldValueImpl && deepEqual(this.vu, e.vu);
  }
};
var __PRIVATE_ArrayRemoveFieldValueImpl = class ___PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), n = this.vu.map((e2) => __PRIVATE_parseData(e2, t)), r2 = new __PRIVATE_ArrayRemoveTransformOperation(n);
    return new FieldTransform(e.path, r2);
  }
  isEqual(e) {
    return e instanceof ___PRIVATE_ArrayRemoveFieldValueImpl && deepEqual(this.vu, e.vu);
  }
};
var __PRIVATE_NumericIncrementFieldValueImpl = class ___PRIVATE_NumericIncrementFieldValueImpl extends FieldValue {
  ...
  isEqual(e) {
    return e instanceof ___PRIVATE_NumericIncrementFieldValueImpl && this.Fu === e.Fu;
  }
};
...
function __PRIVATE_parseUpdateVarargs(e, t, n, r2, i, s) {
  const o = e.Cu(1, t, n), _ = [__PRIVATE_fieldPathFromArgument$1(t, r2, n)], a = [i];
  if (s.length % 2 != 0)
...
function __PRIVATE_parseQueryValue(e, t, n, r2 = false) {
  return __PRIVATE_parseData(n, e.Cu(r2 ? 4 : 3, t));
}
...
function onSnapshot(e, ...t) {
  ...
  return function __PRIVATE_firestoreClientListen(e2, t2, n2, r3) {
    ...
    return e2.asyncQueue.enqueueAndForget(() => __async(this, null, function* () {
      ...
      i2.Qa(), e2.asyncQueue.enqueueAndForget(() => __async(this, null, function* () {
...
function runTransaction(e, t, n) {
  ...
  const r2 = Object.assign(Object.assign({}, be2), n);
  ...
  return function __PRIVATE_firestoreClientTransaction(e2, t2, n2) {
    ...
    return e2.asyncQueue.enqueueAndForget(() => __async(this, null, function* () {
      ...
      new __PRIVATE_TransactionRunner(e2.asyncQueue, i, n2, t2, r3).Ya();
    })), r3.promise;
...
!function __PRIVATE_registerFirestore(e, t = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(w2, "4.6.0", e), // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
  registerVersion(w2, "4.6.0", "esm2017");
}();
...
var Firestore2 = class {
  ...
  collection(pathString) {
    try {
      return new CollectionReference2(this, collection(this._delegate, pathString));
    } catch (e) {
  ...
  collectionGroup(collectionId) {
    try {
      return new Query2(this, collectionGroup(this._delegate, collectionId));
    } catch (e) {
      throw replaceFunctionName(e, "collectionGroup()", "Firestore.collectionGroup()");
    }
  }
  runTransaction(updateFunction) {
    return runTransaction(this._delegate, (transaction) => updateFunction(new Transaction2(this, transaction)));
  }
  batch() {
...
var DocumentReference2 = class _DocumentReference {
  ...
  get parent() {
    return new CollectionReference2(this.firestore, this._delegate.parent);
  }
  get path() {
  ...
  collection(pathString) {
    try {
      return new CollectionReference2(this.firestore, collection(this._delegate, pathString));
    } catch (e) {
...
var FieldValue2 = class _FieldValue {
  constructor(_delegate) {
    this._delegate = _delegate;
  }
...
function registerFirestore(instance) {
  configureForFirebase(instance, (app, firestoreExp) => new Firestore2(app, firestoreExp, new IndexedDbPersistenceProvider()));
